...
void PWM_Init(uint16_t period, uint16_t duty1, uint16_t duty2){
  ...
  P2DIR |= 0xC0;          // P2.4, P2.5 output
  P2SEL0 |= 0xC0;         // P2.4, P2.5 Timer0A functions
  P2SEL1 &= ~0xC0;        // P2.4, P2.5 Timer0A functions
  ...
  TA0CCTL4 = 0x0040;      // CCR2 toggle/reset
  TA0CCR4 = duty2;        // CCR2 duty cycle is duty2/period
